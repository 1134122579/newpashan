...
t.prototype.getWxLocation = function(t, e) {
    ...
    function e(e) {
        ...
        wx.request({
            ...
            success: function(a) {
                ...
                a.data.status && "1" == a.data.status ? (s = (o = a.data.regeocode).addressComponent, 
    ...
    function e(e) {
        ...
        t.type && "forecast" == t.type && (a = "all"), wx.request({
            ...
            success: function(e) {
                var a, o;
                e.data.status && "1" == e.data.status ? e.data.lives ? (a = e.data.lives) && a.length > 0 && ((o = function(t) {
                    return {
                        city: {
                            text: "城市",
                            data: t.city
                ...
                }(a = a[0])).liveData = a, t.success(o)) : e.data.forecasts && e.data.forecasts[0] && t.success({
